...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <form
        onSubmit={submit}
        className="w-full max-w-md rounded-lg border border-border bg-primary/10 p-5 space-y-4"
      >
        ...
        <div className="space-y-1">
          ...
          />
          <StrengthBar password={form.confirmPassword} />
        </div>
        ...
        <Button
          type="submit"
          className={cn("p-6 cursor-pointer hover:opacity-85 w-full")}
          disabled={loading}
        >
